...
/**
 * Process sullivan ela 1-50.pdf questions into individual JSON files
 * Run: node scripts/process-sullivan-ela.cjs
 */
...
// Questions extracted from sullivan ela 1-50.pdf
const questions = [
  {
    questionId: "2cd8bd76",
    section: "Reading",
  ...
  },
  {
    ...
    skill: "Command of Evidence",
    difficulty: "Medium",
    prompt: `<p>The Post Office is a 1912 play by Rabindranath Tagore, originally written in Bengali. The character Amal is a young boy who imagines that the people he sees passing the window of his home are carefree even when engaged in work or chores, as is evident when he says to the daughter of a flower seller, ______</p><p>Which quotation from The Post Office most effectively illustrates the claim?</p>`,
    choices: {
  ...
  },
  {
    ...
    correctChoice: "A",
    rationale: `<p>Choice A is the best answer because it best describes data from the graph that support the researchers' conclusion about whitefly-induced defenses in tomato plants.</p>`
  },
  {
    questionId: "4aa75b60",
    section: "Reading",
  ...
  },
  {
    ...
    choices: {
      A: { body: "<p>The soil surrounding healthy plants contained significantly higher concentrations of microbes known to inhibit Ralstonia solanacearum than the soil surrounding diseased plants did.</p>" },
      B: { body: "<p>The soil surrounding the plants contained high concentrations of Ralstonia solanacearum regardless of whether the plants were affected by wilt disease.</p>" },
    ...
    correctChoice: "A",
    rationale: `<p>Choice A is the best answer. This choice provides evidence that directly links the presence of R. solanacearum-inhibiting microbes in the soil to the health of tomato plants.</p>`
  },
  {
    questionId: "bf1fe112",
    section: "Reading",
  ...
  },
  {
    ...
    choices: {
      A: { body: "<p>bacteria carried by wind are typically less beneficial to A. thaliana than soil-based bacteria are.</p>" },
      B: { body: "<p>some bacteria in A. thaliana leaves and roots may share a common source.</p>" },
      C: { body: "<p>many bacteria in A. thaliana leaves may have been deposited by means other than rain.</p>" },
      D: { body: "<p>A. thaliana leaves and roots are especially vulnerable to harmful bacteria.</p>" }
    },
    correctChoice: "B",
  ...
  },
  {
    ...
    skill: "Command of Evidence",
    difficulty: "Hard",
    prompt: `<p>Black beans (Phaseolus vulgaris) are a nutritionally dense food, but they are difficult to digest in part because of their high levels of soluble fiber and compounds like raffinose. They also contain antinutrients like tannins and trypsin inhibitors, which interfere with the body's ability to extract nutrients from foods. In a research article, Marisela Granito and Glenda Álvarez from Simón Bolívar University in Venezuela claim that inducing fermentation of black beans using lactic acid bacteria improves the digestibility of the beans and makes them more nutritious.</p><p>Which finding from Granito and Álvarez's research, if true, would most directly support their claim?</p>`,
    choices: {
      ...
      C: { body: "<p>When the fermented beans were analyzed, they were found to contain two microorganisms, Lactobacillus casei and Lactobacillus plantarum, that are theorized to increase the amount of nitrogen absorbed by the gut after eating beans.</p>" },
  ...
  },
  {
    ...
    skill: "Command of Evidence",
    difficulty: "Easy",
    prompt: `<p>O Pioneers! is a 1913 novel by Willa Cather. In the novel, Cather portrays Alexandra Bergson as having a deep emotional connection to her natural surroundings: ______</p><p>Which quotation from O Pioneers! most effectively illustrates the claim?</p>`,
    choices: {
...
questions.forEach(q => {
  const filename = `${q.questionId}.json`
...
console.log(`\nProcessed ${questions.length} questions from sullivan ela 1-50.pdf`)
